    ...
    <>
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        <div className="text-center mb-8 relative">
          ...
          <div className="max-w-4xl mx-auto space-y-3 text-center mb-6 relative z-10">
            <p className="font-montserrat text-lg text-[#2E2A26] leading-snug">
            ...
            <p className="font-montserrat text-lg text-[#2E2A26] leading-snug font-semibold">
