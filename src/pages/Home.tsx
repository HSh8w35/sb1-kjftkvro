    ...
    <>
        ...
        <div className="max-w-7xl mx-auto relative z-10 w-full h-full flex flex-col justify-center py-12 md:py-20">
          <div className="max-w-4xl mx-auto text-center px-4">
            ...
            <div className="space-y-6 md:space-y-8">
              <h1 className="text-2xl md:text-3xl lg:text-4xl italic text-black/90 leading-relaxed px-4 font-normal" style={{ fontFamily: "'Monotype Corsiva', cursive" }}>
      ...
      <section className="py-20 bg-[#F6F1E8] relative overflow-hidden">
        ...
        <div className="px-6 lg:px-8 relative z-10">
          ...
          <div className="text-lg md:text-xl text-[#2E2A26]/80 leading-relaxed max-w-4xl mx-auto text-center mb-16 space-y-6">
            <p>
